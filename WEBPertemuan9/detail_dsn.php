...
$nidn = $_GET['nidn'];
$camaba = query("SELECT * FROM tb_dosen WHERE nidn=$nidn");
//var_dump($camaba)
 ?>
...
<ul class = "list-group">
  <li class = "list-group-item"><img src="gambar/<?=$camaba ['foto_dosen'];?>"width="100px"></li>
  <li class = "list-group-item active"><?=$camaba ['Nama'];?></li>
  <li class = "list-group-item"><?=$camaba ['nidn'];?></li>
  <li class = "list-group-item"><?=$camaba ['jenis_kelamin'];?></li>
  <li class = "list-group-item"><?=$camaba ['alamat_rumah'];?></li>
  <li class = "list-group-item"><?=$camaba ['agama'];?></li>
  <li class = "list-group-item"><?=$camaba ['pendidikan_s1'];?></li>
  <li class = "list-group-item"><?=$camaba ['pendidikan_s2'];?></li>
  <li class = "list-group-item"><?=$camaba ['pendidikan_s3'];?></li>
  <li class = "list-group-item">
  <a href="hapus.php?nidn=<?php echo $camaba['nidn']?>" class="btn btn-primary" role= "button">Hapus</a>
