  ...
  <div class="row">
    <div class="col-md-2 pr-3 pt-4 bg-secondary">
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="#"><i class="fas fa-chalkboard-teacher"></i> Daftar Buku</a>
          <hr>
        </li>
        <li class="nav-item">
    ...
    <div class="col-md-10 p-4 pt-4">
      <!-- konten -->
      <h3><i class="fas fa-users"></i> Detail Data Anggota</h3>
      <hr>
      ...
      <ul class="list-group">
        ...
        <li class="list-group-item"><img src="Image/<?= $camaba['foto']; ?>" width="120px"></li>
