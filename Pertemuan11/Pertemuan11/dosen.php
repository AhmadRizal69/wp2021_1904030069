...
$camaba = query("SELECT * FROM tb_dosen")
 ?>
        ...
        <div class="row mt-4">
          <div class="col-md-2 mt-2 pr-3 pt-4 bg-secondary">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                  <a class="nav-link text-white" href="dosen.php"><i class="fas fa-chalkboard-teacher"></i> Daftar Dosen</a> <hr>
                </li>
                <li class="nav-item">
          ...
          <div class="col-md-10 p-5 pt-5">
            <!-- konten -->
            <h3><i class="fas fa-users"> </i>Dosen Fakultas Teknik</h3> <hr>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="detail_dsn.php?nidn=<?= $cmb['nidn']?>" class="btn btn-info" role= "button">Detail</a></td>
